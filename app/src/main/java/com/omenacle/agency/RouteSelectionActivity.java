...
public class RouteSelectionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationRecyclerView.setLayoutManager(new LinearLayoutManager(RouteSelectionActivity.this));
    ...
    private void updateUI(FirebaseUser currentUser) {
        branch_key = currentUser.getUid();
            getRoutes(new OnGetFirebaseDataListener() {
                @Override
                public void onStart() {
                    pd = new ProgressDialog(RouteSelectionActivity.this );
                ...
                public void onSuccess(DataSnapshot dataSnapshot) {
                    ...
                    Toast.makeText(RouteSelectionActivity.this, getResources().getString(R.string.select_route), Toast.LENGTH_LONG).show();
