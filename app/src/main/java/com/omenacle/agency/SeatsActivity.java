...
import com.omenacle.agency.Adapters.SeatsLocationListAdapter;
...
public class SeatsActivity extends AppCompatActivity implements SeatsLocationListAdapter.SeatsAdapterCallback {

    private DatabaseReference mDatabase;
    SeatsLocationListAdapter seatsLocationListAdapter;
    ProgressDialog pd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationRecyclerView.setLayoutManager(new LinearLayoutManager(SeatsActivity.this));
        seatsLocationListAdapter = new SeatsLocationListAdapter(mRouteList, mSeatList, locationRecyclerView, this);
    ...
    private void updateUI(FirebaseUser currentUser) {
        ...
        getRoutes(new OnGetFirebaseDataListener() {
            @Override
            public void onStart() {
                pd = new ProgressDialog(SeatsActivity.this );
            ...
            public void onSuccess(DataSnapshot dataSnapshot) {
                ...
                Toast.makeText(SeatsActivity.this, getResources().getString(R.string.select_route), Toast.LENGTH_LONG).show();
    ...
    void getRoutes(final OnGetFirebaseDataListener listener){
        ...
        mDatabase.child("r").orderByChild("b_k").equalTo(branch_key).addListenerForSingleValueEvent(mGetRouteListListener);
    }
        ...
        buttonAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!TextUtils.isEmpty(seatEditText.getText()) && currentCheckState != null)
                {
                    ...
                    mDatabase.child("s").child(finalNewSeat.getR_k()).setValue(finalNewSeat).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
