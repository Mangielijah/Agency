...
public class VipSeatsLocationListAdapter extends RecyclerView.Adapter<VipSeatsLocationListAdapter.ViewHolder> {
    ...
    public VipSeatsLocationListAdapter(List<Route> mRouteList, List<Seats> mSeatList, RecyclerView mRecyclerView, Context ctx) {
