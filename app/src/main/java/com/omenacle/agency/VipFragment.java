...
public class VipFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layoutView = inflater.inflate(R.layout.fragment_vip, container, false);
    ...
    void getBranchInfo(final OnGetFirebaseDataListener listener, String UID){
        ...
        mDatabase.child("b").orderByChild("k").equalTo(currentUser.getUid()).addListenerForSingleValueEvent(mGetRouteListListener);
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId())
        {
            case R.id.btn_route:
                ...
                Intent intent = new Intent(ctx, VIPRouteActivity.class);
                intent.putExtra("AGENCY_KEY", mBranch.getA_k());
                intent.putExtra("BRANCH", mBranch.getB());
                startActivity(intent);
                break;
            case R.id.btn_validate:
                startActivity(new Intent(ctx, VIPRouteSelectionActivity.class));
                break;
